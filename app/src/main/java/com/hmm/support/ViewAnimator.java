...
//        this.screenShotable = screenShotable;
        ...
        for (int i = 0; i < size; i++) {
            ...
            viewMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    switchItem(list.get(finalI), location[1] + v.getHeight() / 2, v);
                }
            });
            ((ImageView) viewMenu.findViewById(yalantis.com.sidemenu.R.id.menu_item_image)).setImageResource(list.get(i).getImageRes());
    ...
    private void switchItem(Resourceble slideMenuItem, int topPosition, View v) {
        animatorListener.onSwitch(slideMenuItem, topPosition, v);
        hideMenuContent();
    }
